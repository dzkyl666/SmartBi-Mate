...
from smartbi_mate.observability.callbacks import ToolAuditCallback
from smartbi_mate.observability.context import set_run_context
from smartbi_mate.utils import log


def _resolve_observability_cfg() -> Any:
    try:
        from smartbi_mate import config as _cfg
...
def build_run_config(
    ...
    cfg.setdefault("run_name", f"smartbi_mate:{user_id}:{session_id}")
