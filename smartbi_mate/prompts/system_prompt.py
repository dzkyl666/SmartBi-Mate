...
def get_dialect_rules():
    ...
    if _dialect_rules_cache is None:
        dialect_dir = importlib.resources.files("smartbi_mate.prompts.sql_dialect")
...
def get_agent_prompt_template() -> str:
    ...
    if _agent_prompt_template_cache is None:
        with importlib.resources.files("smartbi_mate.prompts").joinpath("agent_prompt.md").open("r", encoding="utf-8") as f:
            prompt = f.read()
...
def get_extraction_prompt_template() -> str:
    ...
    if _extraction_prompt_template_cache is None:
        with importlib.resources.files("smartbi_mate.prompts").joinpath("extraction_prompt.md").open("r", encoding="utf-8") as f:
            prompt = f.read()
...
def get_table_selection_prompt_template() -> str:
    ...
    if _table_selection_prompt_template_cache is None:
        with importlib.resources.files("smartbi_mate.prompts").joinpath("schema_linking_prompt.md").open("r", encoding="utf-8") as f:
            prompt = f.read()
...
def get_text2sql_prompt_template() -> str:
    ...
    if _text2sql_prompt_template_cache is None:
        with importlib.resources.files("smartbi_mate.prompts").joinpath("text2sql_prompt.md").open("r", encoding="utf-8") as f:
            prompt = f.read()
...
def get_visualization_prompt_template() -> str:
    ...
    if _visualization_prompt_template_cache is None:
        with importlib.resources.files("smartbi_mate.prompts").joinpath("visualization_prompt.md").open("r", encoding="utf-8") as f:
...
def get_summary_prompt_template() -> str:
    ...
    if _summary_prompt_template_cache is None:
        with importlib.resources.files("smartbi_mate.prompts").joinpath("summary_prompt.md").open("r", encoding="utf-8") as f:
