...
implementation of :class:`~smartbi_mate.catalog.catalog_store.CatalogStore`.

Compared to :class:`~smartbi_mate.catalog.store.file_system.FileSystemCatalogStore`
