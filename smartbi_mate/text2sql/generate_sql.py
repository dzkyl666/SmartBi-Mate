...
from smartbi_mate.constants import (
    SQL_EXECUTE_TIMEOUT,
    SQL_NA,
    SQL_RESULT_LIMIT,
    SQL_SECURITY_ERROR,
...
from smartbi_mate.memory_config import get_memory_config
from smartbi_mate.memory_scoring import composite_score
from smartbi_mate.observability.audit import AuditLogger
from smartbi_mate.observability.context import get_run_context
from smartbi_mate.prompts.system_prompt import get_text2sql_dialect_prompt_template
from smartbi_mate.text2sql.confidence import CONFIDENCE_STATUS_EVALUATOR_ERROR, CONFIDENCE_STATUS_OK, SimpleSQLEvaluator
from smartbi_mate.text2sql.data import get_learned_sql_store, sql_example_dicts, sql_example_retriever
from smartbi_mate.text2sql.errors import (
    EmptyResultError,
    SQLSecurityError,
    Text2SQLError,
    classify_sql_exception,
)
from smartbi_mate.text2sql.visualization import VisualizationService
from smartbi_mate.utils import get_text_from_content, log
...
def _limit_sql_query(sql: str, limit: int = SQL_RESULT_LIMIT) -> str:
    ...
    return f"SELECT * FROM (\n{normalized_sql}\n) AS smartbi_mate_limited_result LIMIT {limit}"  # nosec
