...
from smartbi_mate.llm.llm import get_default_llm
from smartbi_mate.utils import extract_json_from_answer, log
...
def _get_rubric_prompt_template() -> str:
    ...
    if _rubric_prompt_template_cache is None:
        with importlib.resources.files("smartbi_mate.prompts").joinpath("sql_confidence_prompt.md").open("r") as f:
